*****************************************************
* Attica R&D Projects and Regional Development
* Stata .do file – project-level models (EE1, EE2, EE3, EE5)
* All comments and labels in English for client-facing delivery.
*****************************************************
...
*----------------------------------------------------
* 2. Restrict the sample to Attica only
*----------------------------------------------------

keep if Region == "Attica"
...
rename Researchers_numbers_Region_End_Year     researchers_end
...
*    questions for Attica, estimated at project level.
*----------------------------------------------------
...
putexcel set "attica_stata_results.xlsx", replace
...
* End of Attica analysis .do file
*****************************************************
