# Quick Start - Version 5.3.1

Version 5.3.1 retains the v5.2.1 workflow and the v5.3.0 Research Command Chair. It fixes empty descriptive output and makes questions execute deterministic analysis against the saved XLSX/CSV scope before producing a natural-language answer. Use Module 12B after data audit to restrict variables, rows, years and PDF evidence, document the research protocol, and export a paper blueprint.
