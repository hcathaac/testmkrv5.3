...
- Version 5.3.0 adds `research_chair.py` as an isolated free/offline protocol and evidence-scoping layer; v5.3.1 fixes its all-numeric default, command execution and light-surface text contrast.
