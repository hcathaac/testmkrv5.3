"""Makryvelios Research Analytics & Econometrics Workbench v5.3.1.
...
/* Typed text and user chat content sit on light controls/bubbles: force true black. */
.stApp main input,.stApp main textarea,.stApp main [contenteditable="true"],[data-baseweb="input"] input,[data-baseweb="textarea"] textarea{color:#101318!important;-webkit-text-fill-color:#101318!important;caret-color:#101318!important}
.stApp main input::placeholder,.stApp main textarea::placeholder{color:#59616d!important;-webkit-text-fill-color:#59616d!important;opacity:1!important}
...
if page == "1. Executive overview":
    ...
    st.subheader("Version 5.3.1 documentation library")
