# Makryvelios Research Analytics & Econometrics Command Centre v5.3.1
...
Version 5.3.1 retains the complete v5.2.1 documentation set and the v5.3.0 Research Command Chair, and adds:
...
This ZIP retains the folder name `makryvelios_dashboard_v2` for compatibility, but the software inside is version 5.3.1. Replace the old repository folder with the new one and keep the Streamlit main-file path as `makryvelios_dashboard_v2/app.py`. Streamlit rebuilds automatically after the GitHub commit.
